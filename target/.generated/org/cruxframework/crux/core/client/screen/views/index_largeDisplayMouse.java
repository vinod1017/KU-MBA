...
public class index_largeDisplayMouse extends View {
  protected index_largeDisplayMouse(String id){
    super(id);
    setTitle(null);
    this.iocContainer = new org.cruxframework.crux.core.client.ioc.IocContainer_index_largeDisplayMouse(this);
    this.registeredControllers = new org.cruxframework.crux.core.client.controller.RegisteredControllers_index_largeDisplayMouse(this, iocContainer);
    this.registeredFormatters = new org.cruxframework.crux.core.client.formatter.RegisteredFormatters_index();
    this.registeredDataSources = new org.cruxframework.crux.core.client.datasource.RegisteredDataSources_index_largeDisplayMouse(this, iocContainer);
...
public org.cruxframework.crux.core.client.ioc.IocContainer_index_largeDisplayMouse getTypedIocContainer(){
  return iocContainer;
}
...
protected org.cruxframework.crux.core.client.ioc.IocContainer_index_largeDisplayMouse iocContainer;
private final View __view = this;
private static java.util.logging.Logger logger = java.util.logging.Logger.getLogger(index_largeDisplayMouse.class.getName());
