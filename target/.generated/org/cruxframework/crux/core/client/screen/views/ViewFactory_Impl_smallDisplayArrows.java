...
public class ViewFactory_Impl_smallDisplayArrows implements org.cruxframework.crux.core.client.screen.views.ViewFactory {
  ...
  public void createView(String name, String id, CreateCallback callback) throws InterfaceConfigException{ 
    ...
    if (StringUtils.unsafeEquals(name, "index")){
      callback.onViewCreated(new org.cruxframework.crux.core.client.screen.views.index_smallDisplayArrows(id));
  ...
  public org.cruxframework.crux.core.client.screen.DeviceAdaptive.Device getCurrentDevice(){ 
    return org.cruxframework.crux.core.client.screen.DeviceAdaptive.Device.smallDisplayArrows;
  }
}
