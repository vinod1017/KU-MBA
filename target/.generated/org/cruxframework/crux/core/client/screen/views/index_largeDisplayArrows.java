...
public class index_largeDisplayArrows extends View {
  protected index_largeDisplayArrows(String id){
    super(id);
    setTitle(null);
    this.iocContainer = new org.cruxframework.crux.core.client.ioc.IocContainer_index_largeDisplayArrows(this);
    this.registeredControllers = new org.cruxframework.crux.core.client.controller.RegisteredControllers_index_largeDisplayArrows(this, iocContainer);
    this.registeredFormatters = new org.cruxframework.crux.core.client.formatter.RegisteredFormatters_index();
    this.registeredDataSources = new org.cruxframework.crux.core.client.datasource.RegisteredDataSources_index_largeDisplayArrows(this, iocContainer);
    org.cruxframework.crux.core.client.screen.views.smartFacesResources_largeDisplayArrows.init();
    org.cruxframework.crux.core.client.screen.views.xStandardResources_largeDisplayArrows.init();
  }
  ...
  protected void render(com.google.gwt.user.client.ui.Panel rootPanel, final org.cruxframework.crux.core.client.screen.views.View.RenderCallback renderCallback) throws InterfaceConfigException{
    if (this.viewPanel == null){
      this.viewPanel = new com.google.gwt.user.client.ui.HTMLPanel("   ");
      rootPanel.add(this.viewPanel);
...
public org.cruxframework.crux.core.client.ioc.IocContainer_index_largeDisplayArrows getTypedIocContainer(){
  return iocContainer;
}
...
protected org.cruxframework.crux.core.client.ioc.IocContainer_index_largeDisplayArrows iocContainer;
private final View __view = this;
private static java.util.logging.Logger logger = java.util.logging.Logger.getLogger(index_largeDisplayArrows.class.getName());
